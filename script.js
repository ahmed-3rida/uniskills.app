...
const translations = {
    ar: {
        ...
        'footer.description': 'منصة تعليمية حديثة لمساعدة الطلاب على التعلم بذكاء',
        'footer.terms': 'شروط الخدمة',
        'footer.copyright': '© 2024 UniSkills. جميع الحقوق محفوظة.',
        ...
        'terms.usage.title': '2. استخدام المنصة',
        ...
        'terms.account.title': '3. حساب المستخدم',
        ...
        'terms.intellectual.title': '4. الملكية الفكرية',
        'terms.intellectual.p1': 'جميع المحتويات المتاحة على منصة UniSkills، بما في ذلك النصوص والرسومات والشعارات والصور والمقاطع الصوتية والفيديو والبرمجيات، هي ملك لـ UniSkills أو مرخصيها وتخضع لحقوق النشر وقوانين الملكية الفكرية.',
        ...
        'terms.content.title': '5. محتوى المستخدم',
        ...
        'terms.privacy.title': '6. الخصوصية وحماية البيانات',
        ...
        'terms.payments.title': '7. المدفوعات والاشتراكات',
        ...
        'terms.termination.title': '9. إنهاء الخدمة',
        ...
        'terms.changes.title': '10. التغييرات على الخدمة',
        ...
        'terms.law.title': '11. القانون الحاكم',
        'terms.law.p1': 'تخضع هذه الشروط وتفسر وفقاً لقوانين جمهورية مصر العربية. أي نزاعات تنشأ عن هذه الشروط ستخضع للاختصاص القضائي الحصري للمحاكم المصرية.',
        'terms.contact.title': '12. الاتصال بنا',
        'terms.contact.p1': 'إذا كان لديك أي أسئلة حول هذه الشروط، يرجى الاتصال بنا عبر:',
        'terms.severability.title': '13. قابلية الفصل',
        'terms.severability.p1': 'إذا تبين أن أي حكم من أحكام هذه الشروط غير قابل للتنفيذ أو غير صالح، فسيتم تعديل هذا الحكم وتفسيره لتحقيق أهداف هذا الحكم إلى أقصى حد ممكن بموجب القانون المعمول به، وستظل الأحكام المتبقية سارية المفعول بالكامل.',
        'terms.entire.title': '14. الاتفاقية الكاملة',
        'terms.entire.p1': 'تشكل هذه الشروط، جنباً إلى جنب مع سياسة الخصوصية الخاصة بنا، الاتفاقية الكاملة بينك وبين UniSkills فيما يتعلق باستخدام الخدمة وتحل محل جميع الاتفاقيات والتفاهمات السابقة.',
    ...
    en: {
        ...
        'footer.description': 'Modern learning platform to help students learn smarter',
        'footer.terms': 'Terms of Service',
        'footer.copyright': '© 2024 UniSkills. All rights reserved.',
        // Terms page translations
        ...
        'terms.usage.title': '2. Platform Usage',
        ...
        'terms.account.title': '3. User Account',
        ...
        'terms.intellectual.p1': 'All content available on the UniSkills platform, including text, graphics, logos, images, audio clips, videos, and software, is owned by UniSkills or its licensors and is subject to copyright and intellectual property laws.',
        ...
        'terms.content.title': '5. User Content',
        ...
        'terms.privacy.title': '6. Privacy and Data Protection',
        ...
        'terms.payments.title': '7. Payments and Subscriptions',
        ...
        'terms.termination.title': '9. Service Termination',
        ...
        'terms.changes.title': '10. Changes to Service',
        ...
        'terms.law.p1': 'These terms are governed by and construed in accordance with the laws of the Arab Republic of Egypt. Any disputes arising from these terms will be subject to the exclusive jurisdiction of Egyptian courts.',
        'terms.contact.title': '12. Contact Us',
        'terms.contact.p1': 'If you have any questions about these terms, please contact us via:',
        'terms.severability.title': '13. Severability',
        'terms.severability.p1': 'If any provision of these terms is found to be unenforceable or invalid, that provision will be modified and interpreted to achieve the objectives of that provision to the maximum extent possible under applicable law, and the remaining provisions will remain in full force and effect.',
        'terms.entire.title': '14. Entire Agreement',
        'terms.entire.p1': 'These terms, together with our Privacy Policy, constitute the entire agreement between you and UniSkills regarding the use of the service and supersede all prior agreements and understandings.',
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll(
        '.feature-card, .coming-card, .social-link, .about-text, .about-visual'
    );
